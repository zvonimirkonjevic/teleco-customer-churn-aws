...
name_prefix    = "telco-customer-churn"
s3_bucket_name = "zvonimir-telco-customer-churn"

# Sagemaker endpoint configuration variables
sagemaker_endpoint_default_region = "eu-central-1"
sagemaker_model_data_uri = "s3://zvonimir-telco-customer-churn/models/xgboost/sagemaker-xgboost-260223-1743-015-d0d9d493/output/model.tar.gz"
sagemaker_max_concurrency = 1
sagemaker_memory_size_in_mb = 2048

# VPC configuration variables
vpc_name = "telco-customer-churn-vpc"
...
alb_sg_name = "telco-customer-churn-alb-sg"
...
ecs_task_sg_name = "telco-customer-churn-ecs-task-sg"
ecs_task_sg_ingress_protocol = "tcp"
container_port = 8501

# ECS Task Definition configuration variables
container_name = "telco-customer-churn"
container_cpu = 256
container_memory = 512
container_image = "879801897034.dkr.ecr.eu-central-1.amazonaws.com/telco-customer-churn-prediction-app:latest"
region = "eu-central-1"
...
lambda_image_uri = "879801897034.dkr.ecr.eu-central-1.amazonaws.com/telco-customer-churn-prediction-api:latest"